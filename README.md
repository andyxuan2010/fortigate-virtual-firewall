...
parallel single-node and two-node HA provisioning with explicit placeholders
for FortiGate-specific AWS integration that is not yet available.
...
lists the missing FortiGate AMI, bootstrap, load-balancing, and HA route-failover
